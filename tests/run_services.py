...
def run_jsm():
    ...
    from jobmon.server.services.job_state_manager.app import get_app

    app = get_app(os.environ['host'], os.environ['conn_str'])
...
def run_jqs():
    from jobmon.client.the_client_config import get_the_client_config
    from jobmon.server.services.job_query_server.app import get_app
