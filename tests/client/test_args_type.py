...
def test_script():
    ...
    test_script = os.path.abspath(os.path.expanduser(
        f"{this_file}/../_scripts/node_arg_type_check.py"))
    return test_script


@pytest.mark.parametrize("input, expect", [("1", "1"),  # str
                                           (1, "1"),  # int
                                           (1.1, "1.1"),  # float
