...
from jobmon.server.web.db_connection_config import DBConnectionConfig
from jobmon.server.web.handlers import add_request_hooks


def create_app(db_connection_config: Optional[DBConnectionConfig] = None):
    """Create a Flask app"""
    app = Flask(__name__)

    if DBConnectionConfig is None:
        db_connection_config = DBConnectionConfig.from_defaults()
