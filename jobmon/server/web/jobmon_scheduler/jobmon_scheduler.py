...
from jobmon.server.web.server_side_exception import log_and_raise
...
@jobmon_scheduler.errorhandler(Exception)
...
def _is_alive():
    ...
    """
    logger.info(f"{os.getpid()}: {jobmon_scheduler.__class__.__name__} received is_alive?")
