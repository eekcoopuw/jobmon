...
from jobmon.cluster_type.base import ClusterQueue, ClusterDistributor, ClusterWorkerNode, ConcreteResource
...
def get_cluster_worker_node_class() -> Type[ClusterWorkerNode]:
    from jobmon.cluster_type.multiprocess.multiproc_distributor import MultiprocessWorkerNode
