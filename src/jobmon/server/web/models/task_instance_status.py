...
def add_task_instance_statuses(session: Session) -> None:
    ...
    statuses = [
        TaskInstanceStatus(id="D", label="DONE", description="Task instance finished successfully."),
        ...
        TaskInstanceStatus(id="O", label="QUEUED",
                           description="Task instance submitted to the cluster normally, part of a Job Array."),
        TaskInstanceStatus(id="Q", label="QUEUED", description="TaskInstance is queued for submission to the cluster."),
        TaskInstanceStatus(id="R", label="RUNNING", description="Task instance has started running normally."),
