...
def add_workflow_run_statuses(session: Session) -> None:
    ...
    statuses = [
        ...
        WorkflowRunStatus(id="B", label="BOUND", description="WorkflowRun has been bound to the database."),
        ...
        WorkflowRunStatus(id="R", label="RUNNING", description="WorkflowRun is currently running."),
